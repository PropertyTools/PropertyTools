...
### Added
- PropertyGrid: Added `ReadOnlyForeground` dependency property to allow customizing the text color of read-only properties (defaults to `RoyalBlue`) #307
- PropertyGridDemos: Added ReadOnlyTextColorExample demonstrating how to use the new `ReadOnlyForeground` property #307
