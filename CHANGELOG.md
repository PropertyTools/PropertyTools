...
### Fixed
- DataGrid: `ScrollViewerExample` now disables horizontal scrolling on the outer `ScrollViewer` so the DataGrid shrinks to fit the container width when the window is narrowed #176
