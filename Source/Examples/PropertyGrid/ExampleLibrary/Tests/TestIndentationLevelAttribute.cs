// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TestIndentationLevelAttribute.cs" company="PropertyTools">
...
namespace ExampleLibrary
{
    ...
    [PropertyGridExample]
    public class TestIndentationLevelAttribute : TestBase
    {
        ...
        {
            return "Indentation level attribute";
        }
    }
}