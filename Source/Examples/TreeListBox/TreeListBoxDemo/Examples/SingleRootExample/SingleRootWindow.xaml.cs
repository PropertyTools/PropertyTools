// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SingleRootWindow.xaml.cs" company="PropertyTools">
...
namespace TreeListBoxDemo.Examples.SingleRootExample
{
    /// <summary>
    /// Interaction logic for SingleRootWindow.xaml
    /// </summary>
    public partial class SingleRootWindow : Window
    {
        public SingleRootWindow()
        {
            InitializeComponent();
