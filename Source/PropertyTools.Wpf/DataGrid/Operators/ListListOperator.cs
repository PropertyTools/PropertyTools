...
namespace PropertyTools.Wpf
{
    ...
    public class ListListOperator : DataGridOperator
    {
        ...
        /// <inheritdoc />
        public override object GetDataContext(CellRef cell)
        {
            // This returns a data context that is consistent with the generated binding.
            // The binding generated by the ListListOperator assumes that the data context is the entire collection,
            // cf. the GetBindingPath method below.
