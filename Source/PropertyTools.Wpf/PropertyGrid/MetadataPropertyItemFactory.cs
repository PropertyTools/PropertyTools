// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MetadataPropertyItemFactory.cs" company="PropertyTools">
//   Copyright (c) 2014 PropertyTools contributors
// </copyright>
// <summary>
//   Provides a property item factory for the PropertyGrid control that uses the MetadataAttribute.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace PropertyTools.Wpf
{
    ...
    /// </summary>
    public class MetadataPropertyItemFactory : IPropertyItemFactory
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataPropertyItemFactory" /> class.
        /// </summary>
        public MetadataPropertyItemFactory()
        {
        ...
        protected virtual void SetProperties(PropertyItem pi, object instance)
        {
            ...
            var ca2 = pi.GetAttribute<PropertyTools.DataAnnotations.CategoryAttribute>();
            if (ca2 != null)
            {
